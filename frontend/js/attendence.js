window.onload = function () {
    ...
    async function markPresent(student_id) {
        ...
        return fetch("https://localhost:5000/api/add/mark/student", optionslocal)
        // .then(()=>{
            // console.log("added");
        // })
    }
    ...
    function renderStudents(){
        fetch("https://localhost:5000/api/students", options)
            .then((response) => response.json())
            .then((response)=>{
                return fetch("https://localhost:5000/api/marked/student",{
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
